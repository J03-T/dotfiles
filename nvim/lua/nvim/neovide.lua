...
vim.o.guifont="Cascadia Code:h13:#e-antialias:#h-full"
...
vim.keymap.set("n", "<C-_>", ":let g:neovide_scale_factor=g:neovide_scale_factor-0.1<CR>", {noremap = true, silent = true})
